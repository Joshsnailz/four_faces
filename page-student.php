		...
		<div id="maximage">
			<div>
				...
				<div class="in-slide-content" style="display:none;">
					<h2>Get a trip from our Student Package</h2> 
				</div>
			</div>
			<div class="video">
		...
		<div class="col-top agileits w3layouts" id="about">
			...
			<div class="tab-pane  text-style" id="tab7">
					<div class="facts">
						...
						<p> 
						   <ul>
							   <li style="list-style: none;">•	<b>Annual Membership fee:</b> 	<u>$3/year</u></li>
							   <li style="list-style: none;">•	<b>Minimum monthly subscription:</b> <u>$5/month</u></li>
						   </ul> 
						   <br>
						   This exciting club is designed for students, offering a savings plan for local, regional and international educational tours.
						   <br>
							Students can enjoy Cultural tours, History Tours, French Tour, Egyptology Tour, Sports tour, science explorers, engineering and so much more.
							<br>
							 The student club is versatile and provides endless opportunities and exposure for students to travel, learn, experience and explore the world.
						</p>
						   <div class="btn-group">
								<button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#Student">View Destinations</button>
								<!-- Modal -->
								<div class="modal fade bd-example-modal-lg" id="Student" tabindex="-1" role="dialog" aria-labelledby="StudentModalLabel" aria-hidden="true">
