		...
		<div id="maximage">
			<div>
				...
				<div class="in-slide-content" style="display:none;">
					<h2>Get a trip from our African Safari Package</h2> 
				</div>
			</div>
			<div class="video">
		...
		<div class="col-top agileits w3layouts" id="about">
			...
			<div class="tab-pane  text-style" id="tab5">
					<div class="facts">
						...
						<h4>African Safari Club</h4>
						<p> 
						   <ul>
							   <li style="list-style: none;">•	<b>Annual Membership fee:</b> 	<u>$100/year</u></li>
							   <li style="list-style: none;">•	<b>Minimum monthly subscription:</b> <u>$150</u></li>
						   </ul> 
						   <br>
						   This club offers the best tours of Zimbabwe for international tourists and business travellers. The African Safari Club quenches your appetite for Zimbabwe by offering the very best and most intimate destinations. Our Clubs for this club ensure that you get the best experience of the country. Clubs includes Zim on Wheels 5 Routes, The Desert Explorer and The 6 Nation’s Thriller.
						 <p>
						   <div class="btn-group">
								<button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#Africa">View Destinations</button>
								<!-- Modal -->
								<div class="modal fade bd-example-modal-lg" id="Africa" tabindex="-1" role="dialog" aria-labelledby="AfricaModalLabel" aria-hidden="true">
											...
											<div class="table-responsive">
											  <table class="table table-striped">
												  <thead>
													...
													<tr>
														<td>Zim on wheels</td>
														<td>6 Nations Thriller</td>
														<td>Desert Explorer</td>
														<td>Zim Delights</td>
													</tr>
													<tr>
														<td>Business Traveller</td>
														<td>Shuttle Service</td>
														<td>Death by Vic Falls</td>
														<td>CBTE</td>
													</tr>
